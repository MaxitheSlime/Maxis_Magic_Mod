...
public class ModDimensions {
    public static final ResourceKey<LevelStem> MAXIDIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            new ResourceLocation(TwoSidesMod.MOD_ID, "mexidim"));
        ...
        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(
                                Pair.of(Climate.parameters(0.3F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.TEST_BIOME_2)),
                                Pair.of(Climate.parameters(0.3F, 0.1F, 0.1F, 0.0F, 0.0F, 0.1F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.TEST_BIOME)),
                                Pair.of(Climate.parameters(0.1F, 0.2F, 0.0F, 0.2F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(Biomes.BIRCH_FOREST)),
                                Pair.of(Climate.parameters(0.2F, 0.1F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(Biomes.OCEAN)),
