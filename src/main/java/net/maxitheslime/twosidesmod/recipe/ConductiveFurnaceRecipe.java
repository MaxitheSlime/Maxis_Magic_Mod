...
public class ConductiveFurnaceRecipe extends AbstractCookingRecipe {
    ...
    public static class Serializer implements RecipeSerializer<ConductiveFurnaceRecipe> {
        ...
        public static final ConductiveFurnaceRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public ConductiveFurnaceRecipe m_6729_(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            ItemStack itemstack;
            if (pJson.get("result").isJsonObject()) itemstack = ShapedRecipe.m_151274_(GsonHelper.getAsJsonObject(pJson, "result"));
            else {
